...
steps:
1. have an amazon ec2 account, launch a new instance.
2. choose ami-06ad526f (free). 
...
6. ssh -i your.pem ubuntu@ec2-your-public-dns.amazonaws.com (if u got time-out error, check the previous step.)
